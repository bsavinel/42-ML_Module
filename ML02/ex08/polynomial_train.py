...
if __name__ == "__main__":
	...
	plt.plot(Xpill, Yscore, 'b.')
	plt.plot(Xpill, predict1, 'r-', label="degree 1")
	plt.plot(Xpill, predict2, 'y-', label="degree 2")
	plt.plot(Xpill, predict3, 'g-', label="degree 3")
	plt.plot(Xpill, predict4, 'c-', label="degree 4")
	plt.plot(Xpill, predict5, 'm-', label="degree 5")
	plt.plot(Xpill, predict6, 'k-', label="degree 6")
	plt.legend()
	plt.show()