...
if __name__ == "__main__":
	...
	plt.plot(TrueXEval[:,0], TrueYEval, 'bo')
	plt.plot(TrueXEval[:,0], TruePredict, 'g.')
	plt.show()

	plt.plot(TrueXEval[:,1], TrueYEval, 'bo')
	plt.plot(TrueXEval[:,1], TruePredict, 'g.')
	plt.show()

	plt.plot(TrueXEval[:,2], TrueYEval, 'bo')
	plt.plot(TrueXEval[:,2], TruePredict, 'g.')
	plt.show()